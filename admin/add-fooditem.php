...
else
{
    ...
    $query=mysqli_query($con, "insert into tblfood(CategoryName,ItemName,ItemPrice,ItemDes,`Image`,ItemQty) value('$fcat','$itemname','$price','$description','$itempic','$quantity')");
    if ($query) {
