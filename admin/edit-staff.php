...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "update tbladmin set AdminName='$aname', MobileNumber='$mobile' where ID='$sid'");
...
<body>
    ...
    echo $msg;
                      ...
                      <?php
$sid=$_GET['staffid'];
$ret=mysqli_query($con,"select * from tbladmin where ID='$sid'");
$cnt=1;
                            ...
                            <form id="submit" action="#" class="wizard-big" method="post" name="submit">
                                    <fieldset>
                                          <div class="form-group row"><label class="col-sm-2 col-form-label">Full Name:</label>
                                                <div class="col-sm-10"><input name='fullname' id="fullname" class="form-control white_bg" value="<?php  echo $row['AdminName'];?>">
     
       
   </div>
                                            </div>
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">User Name:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="uname" value="<?php  echo $row['UserName'];?>"></div>
                                            </div>
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Password:</label>
                                                <div class="col-sm-10">
                                                 <input type="password" class="form-control" name="pword" readonly="true" value="<?php  echo $row['Password'];?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Registration Date:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="price" readonly="true" value="<?php  echo $row['AdminRegdate'];?>"></div>
                                            </div>
