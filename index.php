...
<?php include_once('includes/header.php');?>
        ...
        <section>
            <div class="block blackish opac50">
                <div class="fixed-bg" style="background-image: url(assets/images/bg.jpg); background-size: cover;"></div>
                <div class="restaurant-searching style2 text-center">
                    <div class="restaurant-searching-inner">
						<!--<span>Fast <i>Food</i> </span>-->
           ...
           <input class="brd-rd30" type="text" placeholder="Search for food..." required="true"  name="searchdata">
	...
	?>
                                        ...
                                        <div class="popular-dish-box style2 wow fadeIn" data-wow-delay="0.2s">
                                            <div class="popular-dish-thumb">
                                                <a href="food-detail.php?fid=<?php echo $row['ID'];?>" title="" itemprop="url"><img src="admin/itemimages/<?php echo $row['Image'];?>" alt="<?php echo $row['ItemName'];?>" itemprop="image" width="400" height="180" style="object-fit: cover;"></a>
                                            </div>
