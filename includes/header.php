...
error_reporting(0);
   ...
   <a  href="my-account.php" title="My Account" itemprop="url">My Account</a>
            ...
            <div class="logo-menu-sec">
                <div class="container">
                    <div class="logo"><h1 itemprop="headline"><a href="index.php" title="Home" itemprop="url">Gigi's</a></h1></div>
                    <nav>
                        <div class="menu-sec">
                            <ul>
...
<li><a href="contact-us.php" title="Contact us" itemprop="url">Contact us </a></li>
         ...
         <?php if (strlen($_SESSION['fosuid']==0)) {?> 
                    <a class="log-popup-btn red-bg brd-rd4" href="#" title="Login" itemprop="url"><i clas</i> My Cart</a> 
                <?php }?>

                                   <?php if (strlen($_SESSION['fosuid']>0)) {?>
                            <a class="red-bg brd-rd4" href="cart.php" title="Register" itemprop="url"><i class="flaticon-book"></i> My Cart</a>
                        <?php } ?>
                        </div>
                    </nav><!-- Navigation -->
                </div>
        ...
        <div class="responsive-header">
            ...
            <div class="responsive-logomenu">
                <div class="logo"><h1 itemprop="headline"><a href="index-2.html" title="Home" itemprop="url">Gigi's</h1></div>
