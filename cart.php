...
$query.="insert into tblorderaddresses(UserId,Ordernumber,Flatnobuldngno,StreetName,Postcode,County,City) values('$userid','$orderno','$fnaobno','$street','$pcode','$county','$city');";
...
$heade .= 'From:Gigi<ghislaine8000@gmail.com>'."\r\n";    
...
?>
<tr>
    <td><img src="admin/itemimages/<?php echo $row['Image']?>" width="100" height="80" alt="<?php echo $row['ItemName']?>" style="object-fit: cover;"></td>
<td>
...
<tr>
<td colspan="3"> 
<input type="text" name="postcode"  placeholder="Postcode" class="form-control" required="true">
</td>
<td colspan="3">
